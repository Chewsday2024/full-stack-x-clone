...
import { formatMemberSinceDate } from "../../utils/formatDate/formatDateFns"
...
function ProfilePage() {
  ...
  const { data: posts } = useQuery<PostType[]>({ queryKey: ["posts"], queryFn: () => postsQueryOption(`/api/posts/user/${username}`) })
